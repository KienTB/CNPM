    ...
    public class SecurityConfig {
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
            http
                    .authorizeHttpRequests(authorize -> authorize
                            ...
                            .requestMatchers(
                                    "/login", "/create_account", "/signup",                                "/session/**",
                                    "/session/**",
                                    "/static/**", "/asset/**",
                                    "/login_styles.css/**",
                                    "/home_page_style.css/**",
                                    "/clockin_style.css/**",
                                    "/style_create.css/**",
                                    "/admin-home_page_style.css/**",
                                    "/employee_styles.css/**",
                                    "/admin-add_employee_style.css/**",
                                    "/admin-clockin_style.css/**",
                                    "/admin-salary_style.css/**",
                                    "/admin-absence_style.css/**",
                                    "/admin-support_style.css/**")
                            .permitAll()
        ...
        public PasswordEncoder passwordEncoder() {
            return new BCryptPasswordEncoder(); // Simple password encoder (should change to BCrypt)
        }
